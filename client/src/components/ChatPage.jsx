...
const ChatPage = () => {
    ...
    return (
        <div className="flex w-[400px] ml-2 h-screen">
            {/* LEFT SIDEBAR */}
                ...
                <div className="overflow-y-auto h-[80vh]">
                    {suggestedUsers.map((s) => {
                        ...
                        return (
                            <div
                                key={s._id}
                                onClick={() => dispatch(setSelectedUser(s))}
                                className="flex gap-3 items-center p-1 rounded-lg hover:bg-gray-300 cursor-pointer"
                            >
            ...
            {selectedUser ? (
                <section className="flex-1 border-l border-gray-300 flex flex-col">
